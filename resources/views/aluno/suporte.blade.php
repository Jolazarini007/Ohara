...
<body>
    ...
    <section>
        ...
        <main>
            ...
            <button type="button" class="botao" id="btUp">Problemas com Email</button>
            ...
            <a href="{{ route('aluno.suporte2') }}" class="botao" id='btDown'>Proximo</a>
